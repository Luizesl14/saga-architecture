...
public class KafkaConfig {
    ...
    private String inventoryValidationGroupTopic;
    ...
    private NewTopic buildTopc(String name){
        return TopicBuilder
                .name(name)
    ...
    public NewTopic inventoryValidationFailTopic(){
        return buildTopc(this.inventoryValidationFailTopic);
    }

    @Bean
    public NewTopic inventoryValidationGroupTopic(){
        return buildTopc(this.inventoryValidationGroupTopic);
    }

    @Bean
    public NewTopic orchestratorTopic(){
        return buildTopc(this.orchestratorTopic);
    }
