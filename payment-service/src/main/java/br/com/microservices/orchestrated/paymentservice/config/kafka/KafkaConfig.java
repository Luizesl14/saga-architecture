...
public class KafkaConfig {
    ...
    private String paymentValidationGroupTopic;
    ...
    public NewTopic paymentValidationFailTopic(){
        return buildTopc(this.paymentValidationFailTopic);
    }

    @Bean
    public NewTopic paymentValidationGroupTopic(){
        return buildTopc(this.paymentValidationGroupTopic);
    }
