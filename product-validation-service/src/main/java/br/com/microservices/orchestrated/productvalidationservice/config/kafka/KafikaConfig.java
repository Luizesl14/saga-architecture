...
public class KafikaConfig {
    ...
    private String productValidationGroupTopic;
    ...
    public NewTopic productValidationFailTopic(){
        return buildTopc(this.productValidationFailTopic);
    }

    @Bean
    public NewTopic productValidationGroupTopic(){
        return buildTopc(this.productValidationGroupTopic);
    }
